...
function startGame() {
    ...
    let welcome = "Loading..."/* + b1 + b2 + b3 */+ "\nplease wait";
    document.getElementById("time").style.visibility = "visible";
    document.getElementById("time").style.color = "darkblue";
    document.getElementById("screen-btn").innerHTML = welcome;
